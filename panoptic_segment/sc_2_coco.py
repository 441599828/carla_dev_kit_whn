...
def convert2panoptic(cityscapesPath=None, outputFolder=None, useTrainId=False, setNames=["val", "train", "test"]):
    ...
    if cityscapesPath is None:
        AssertionError('cityscapesPath is None.')
    if outputFolder is None:
        AssertionError('outputFolder is None.')
    ...
    for setName in setNames:
        ...
        searchFine   = os.path.join(cityscapesPath, setName, "*", "*gt.png")
        # search files
        ...
        for progress, f in enumerate(files):
            ...
            imageId = fileName.replace("_gt.png", "")
            inputFileName = fileName.replace("_gt.png", "_img.png")
            outputFileName = fileName.replace("_gt.png", "_panoptic.png")
